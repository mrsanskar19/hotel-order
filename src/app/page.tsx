...
export default function Home() {
  ...
  const handleOrderPlaced = () => {
    ...
    setTimeout(() => {
      toast({ title: 'Order Updated!', description: "We're preparing your feast.", duration: 5000 });
      setTimeout(() => toast({ title: 'Cooking in Progress', description: 'Our chefs are working their magic.', duration: 5000 }), 4000);
      setTimeout(() => toast({ title: 'Out for Delivery', description: 'Your order is on its way!', duration: 5000 }), 8000);
      setTimeout(() => {
        toast({ title: 'Delivered!', description: 'Enjoy your meal!', duration: 5000 });
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                      {itemsInCategory.map((item) => (
                          <div
                            key={item.id}
                            className="flex items-start gap-4 bg-card p-3 rounded-lg shadow-sm transition-all duration-300 hover:shadow-md cursor-pointer"
